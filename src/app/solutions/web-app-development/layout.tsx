...
export const metadata: Metadata = {
  title: { absolute: 'Web & App Development | Full-Stack Engineering | MoreYeahs' },
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://www.moreyeahs.com/solutions/web-app-development',
  },
  twitter: {
  ...
  alternates: { canonical: 'https://www.moreyeahs.com/solutions/web-app-development' },
};

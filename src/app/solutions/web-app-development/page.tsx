          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: 24, alignItems: 'stretch' }} className="ds-hero-split">
            ...
            >
              <motion.div style={{ y: videoY, position: 'absolute', inset: 0 }}>
                <video autoPlay muted loop playsInline aria-label="Web and app development solutions overview" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover' }}>

...
export const metadata: Metadata = {
  title: { absolute: 'Cloud & Infrastructure Solutions | MoreYeahs' },
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://www.moreyeahs.com/solutions/cloud-infrastructure',
  },
  twitter: {
  ...
  alternates: { canonical: 'https://www.moreyeahs.com/solutions/cloud-infrastructure' },
};

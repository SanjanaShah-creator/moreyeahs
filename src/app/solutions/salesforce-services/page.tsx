        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gridTemplateAreas: '"tl tl tl tl tr tr tr" "bl bl bl br br br br"', gap: 16 }} className="ds-bento">
            ...
            >
              ...
              <Link href="/blog/salesforce-marketing-cloud-implementation-guide" style={{ flex: 1, borderRadius: 14, overflow: 'hidden', border: '1px solid var(--border)', display: 'flex', flexDirection: 'column', textDecoration: 'none', minHeight: 0 }}>
                <div style={{ height: 160, flexShrink: 0, backgroundImage: 'url(https://dev.moreyeahs.com/wp-content/uploads/2025/11/Salesforce-Service-Cloud-Implementation_-A-Complete-Guide-2025.png)', backgroundSize: 'cover', backgroundPosition: 'center' }} />
            ...
            >
              ...
              <div style={{ position: 'absolute', bottom: 0, right: 0, zIndex: 1, width: 280, height: 320, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Image src="/images/robot-with-tick-symbol 3.png" alt="Salesforce solutions robot illustration" width={280} height={280} style={{ objectFit: 'contain' }} />
              </div>
            </motion.div>
          </div>
        </div>

...
export const metadata: Metadata = {
  title: 'Azure Cloud Services | MoreYeahs IT Technologies',
  ...
  openGraph: {
    ...
    url: 'https://moreyeahs.com/solutions/microsoft-services/azure',
  },
  alternates: { canonical: '/solutions/microsoft-services/azure' },
};

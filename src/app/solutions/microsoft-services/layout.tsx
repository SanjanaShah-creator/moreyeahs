...
export const metadata: Metadata = {
  title: { absolute: 'Microsoft Solutions | Dynamics 365, Azure & Power Platform | MoreYeahs' },
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://www.moreyeahs.com/solutions/microsoft-services',
  },
  twitter: {
  ...
  alternates: { canonical: 'https://www.moreyeahs.com/solutions/microsoft-services' },
};

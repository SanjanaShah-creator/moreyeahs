...
export const metadata: Metadata = {
  title: 'SharePoint Services | MoreYeahs IT Technologies',
  ...
  openGraph: {
    ...
    url: 'https://moreyeahs.com/solutions/microsoft-services/sharepoint',
  },
  alternates: { canonical: '/solutions/microsoft-services/sharepoint' },
};

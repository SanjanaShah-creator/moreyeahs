...
const INDUSTRIES = [
  {
    ...
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/Healthcare-Industry-1.mp4',
  },
  {
    ...
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/E-Commerce-Industry-1.mp4',
  },
  {
    ...
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/Real-E-State-Industry-1.mp4',
  },
  {
    Icon: Landmark, slug: 'bfsi', label: 'BFSI',
    points: ['Risk & fraud detection', 'Customer intelligence', 'Process automation'],
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/BFSI-Industry-1.mp4',
  },
  {
    Icon: Globe2, slug: 'public-sector', label: 'Public Sector',
    points: ['Digital citizen services', 'ERP modernization', 'Data governance'],
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/Public-Sector-Industry-1.mp4',
  },
  {
    Icon: Users, slug: 'non-profit', label: 'Non-Profit',
    points: ['Donor management platforms', 'Impact tracking', 'Community engagement'],
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/Non-Profit-Sector-Industry-1.mp4',
  },
  {
    ...
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/Ed-Tech-Industry-1.mp4',
  },
  {
    ...
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/Manufacturing-Industry-1.mp4',
  },
  {
    Icon: CreditCard, slug: 'fintech', label: 'Fintech',
    points: ['Smart payment automation', 'Risk & fraud detection', 'Real-time insights'],
    video: 'https://prod.moreyeahs.com/wp-content/uploads/2026/05/Fintech-Industry-1.mp4',
  },
];
